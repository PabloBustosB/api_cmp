            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e(__('Login')); ?></a>

                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e(__('Register')); ?></a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        <?php endif; ?>
                    ...
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                                <?php echo e(__('Documentation')); ?></h2>
...
<?php /**PATH C:\xampp\htdocs\api-cmp\resources\views/welcome.blade.php ENDPATH**/ ?>